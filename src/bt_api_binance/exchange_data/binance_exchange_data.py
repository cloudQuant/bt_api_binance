...
def _resolve_binance_config_path() -> Path:
    plugin_path = Path(__file__).resolve().parents[1] / "configs" / "binance.yaml"
    if plugin_path.exists():
        return plugin_path
    return get_exchange_config_path("binance.yaml")
...
def _get_binance_config() -> Any | None:
    ...
    try:
        config_path = _resolve_binance_config_path()
...
class BinanceExchangeData(ExchangeData):
    ...
    def _load_from_config(self, asset_type) -> bool:
        ...
        Args: asset_type:  key,  'swap', 'spot', 'coin_m'
        Returns: bool:
...
class BinanceExchangeDataCoinM(BinanceExchangeData):
    """Class BinanceExchangeDataCoinM"""
    def __init__(self) -> None:
        """__init__ method"""
        super().__init__()
...
class BinanceExchangeDataOption(BinanceExchangeData):
    """Class BinanceExchangeDataOption"""
    def __init__(self) -> None:
        """__init__ method"""
        super().__init__()
...
class BinanceExchangeDataMargin(BinanceExchangeData):
    """Class BinanceExchangeDataMargin"""
    def __init__(self) -> None:
        """__init__ method"""
        super().__init__()
