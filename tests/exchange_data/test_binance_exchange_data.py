...
from bt_api_binance.exchange_data.binance_exchange_data import _resolve_binance_config_path
...
class TestBinanceExchangeData:
    ...
    def test_prefers_plugin_packaged_config(self):
        """Test Binance config resolution prefers the plugin package."""
        path = _resolve_binance_config_path()

        assert path.name == "binance.yaml"
        assert "bt_api_binance/configs" in path.as_posix()
