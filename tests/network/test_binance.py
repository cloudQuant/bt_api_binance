...
class TestBinanceRegistry:
    ...
    def test_binance_spot_registered(self):
        ...
        assert ExchangeRegistry.get_exchange_data_class("BINANCE___SPOT") is BinanceExchangeDataSpot
        assert ExchangeRegistry.get_balance_handler("BINANCE___SPOT") is not None
    ...
    def test_binance_swap_registered(self):
        ...
        assert ExchangeRegistry.get_exchange_data_class("BINANCE___SWAP") is BinanceExchangeDataSwap
