...
from bt_api_binance.feeds.vip_loan import BinanceRequestDataVipLoan
...
def test_vip_loan_request_vip_loan_borrow_params():
    ...
    path, params, extra_data = vip_loan._vip_loan_borrow(
        loan_coin="USDT", collateral_coin="BTC", loan_amount=1000, collateral_amount=0.05
    )
...
def test_vip_loan_request_vip_loan_repay_params():
    ...
    path, params, extra_data = vip_loan._vip_loan_repay(
        loan_coin="USDT", collateral_coin="BTC", repay_amount=1000
    )
