...
from bt_api_binance.feeds.mining import BinanceRequestDataMining
...
def test_mining_request_get_mining_worker_list_params():
    ...
    path, params, extra_data = mining._get_mining_worker_list(algo="sha256", user_name="test_miner")
...
def test_mining_request_get_mining_statistics_params():
    ...
    path, params, extra_data = mining._get_mining_statistics(algo="sha256", user_name="test_miner")
